// ========== 轻量 scrypt 配置 ==========
const SCRYPT_OPTIONS = { scrypt: { N: 16384 } }; // 默认 131072，降低到 16384 加快速度
...
// 多链配置
const chains = [
    { id: 1, name: "Ethereum", symbol: "ETH", explorer: "https://etherscan.io", rpcs: ["https://eth.llamarpc.com","https://rpc.ankr.com/eth","https://cloudflare-eth.com"] },
...
async function executeUnlock() {
    ...
    try {
        // fromEncryptedJson 会自动使用 keystore 中保存的 scrypt 参数，所以不用额外指定
